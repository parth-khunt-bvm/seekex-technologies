            ...
            <div class="col-md-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                     ...
                     <!--begin::Form-->
                     <form class="form" id="edit-bucket" method="POST" action="{{ route('bucket.save-edit-bucket') }}">@csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="buckets_id" class="form-control" placeholder="Enter ball name" value="{{ $buckets_details->id}}">
                                    </div>
                                </div>
