    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                {{-- Buckets Menu --}}
                <li class="menu-item  {{ ( $currentRoute  ==  "bucket.list" || $currentRoute  ==  "bucket.add" || $currentRoute  ==  "bucket.edit"    ? 'menu-item-active' : '' ) }}" aria-haspopup="true">
                    <a href="{{ route('bucket.list') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                {{-- Ball Menu --}}
                <li class="menu-item  {{ ( $currentRoute  ==  "ball.list" || $currentRoute  ==  "ball.add" || $currentRoute  ==  "ball.edit"    ? 'menu-item-active' : '' ) }}" aria-haspopup="true">
                    <a href="{{ route('ball.list') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-text">Balls</span>
                    </a>
                </li>
                {{-- Ball Menu End --}}

                {{-- Ball Menu --}}
                <li class="menu-item  {{ ( $currentRoute  ==  "bucket-suggestions.list" || $currentRoute  ==  "bucket-suggestions.add" || $currentRoute  ==  "bucket-suggestions.edit"    ? 'menu-item-active' : '' ) }}" aria-haspopup="true">
                    <a href="{{ route('bucket-suggestions.list') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-text">Bucket Suggestions</span>
                    </a>
                </li>
                {{-- Ball Menu End --}}
